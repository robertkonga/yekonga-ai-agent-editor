...
<template>
  <div class="flex h-screen w-full bg-slate-900 text-slate-200">
    ...
    <div v-if="store.active" class="h-full w-70 border-r border-slate-700 bg-slate-800 flex flex-col">
      <ChatPanel />
    </div>
  </div>
</template>
...
import IDEPanel from './IDE/IDEPanel.vue';
import ChatPanel from './Chat/ChatPanel.vue';
import { getFileColorClass } from './IDE/utils.ts';
