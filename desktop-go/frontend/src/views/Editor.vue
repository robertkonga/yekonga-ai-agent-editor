<template>
    <div class="flex h-full w-full bg-slate-900 text-slate-200">
        ...
        <div v-if="store.active" class="h-full w-70 bg-slate-800 flex flex-col">
            <ChatPanel />
        </div>
    </div>
</template>
...
import IDEPanel from './components/Editor/IDE/IDEPanel.vue';
import ChatPanel from './components/Editor/Chat/ChatPanel.vue';
import { getFileColorClass } from './components/Editor/IDE/utils.ts';
