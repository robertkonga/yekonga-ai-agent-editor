...
<template>
    <div class="group relative flex cursor-pointer items-center gap-3 rounded-md pl-3 pr-4 py-2 transition-colors hover:bg-slate-800 border border-slate-800/50"
        @click="emit('open')" 
